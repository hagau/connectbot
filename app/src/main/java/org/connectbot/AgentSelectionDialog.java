...
public class AgentSelectionDialog extends DialogFragment {
	...
	public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
		...
		mHostEditorFragment = (HostEditorFragment) getFragmentManager().findFragmentById(R.id.fragment_container);
		...
		public void onBindViewHolder(AgentViewHolder holder, int position) {
			...
			if (mSelectedItem != position) {
				...
				if (constantState != null) {
					...
					DrawableCompat.setTint(tintedIcon.mutate(), ResourcesCompat.getColor(mResources, R.color.key_background_normal, null));
